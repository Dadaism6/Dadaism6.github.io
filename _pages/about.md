...
lang: en
lang_ref: about
subtitle: ECE PhD @ UCLA | Prev @ <a href="https://www.accio.com/work">Alibaba Accio</a> | MS. CS 24' | BS. CS 22'
nav_order: 1
profile:
  align: right
...
Hello there! I'm Chenda Duan, `a second-year Ph.D. student in Computer Engineering at UCLA`, where I am fortunate to be advised by Prof. [Vwani Roychowdhury](https://www.vwaniroychowdhury.com/). I was an intern at [Alibaba Accio](https://www.accio.com/work) during 2026, where I do Agentic Post-Training and co-lead the development of [Occamy-1.0](https://huggingface.co/Accio-Lab/occamy-1.0), a frontier 35B co-work model.
</div>
...
<div class="research-blocks">
  ...
  At [Alibaba Accio](https://www.accio.com/work), ·	I am the core owner of the training effort for Accio [Occamy-1.0](https://huggingface.co/Accio-Lab/occamy-1.0), a frontier 35B co-work model. I lead the development of the agentic training infra. I am also responsible for data generation pipeline, RL, and model evaluation..
  </div>
